...
$('.onePieceThread').on('click', function() {
    checkLoginOrNot(function(d) {
        if (d != "offline") {
            ...
            $('#outer-moment').hide();
            $('#inline_image_upload').hide();
            $('#inline_album_upload').hide();

            $('.onePieceBack').show();
            $('#moment').find('.banner_first').show();
        }
    });
...
$('.discussionThread').on('click', function() {
    checkLoginOrNot(function(d) {
        if (d != "offline") {
            ...
            $('#upload-discussion-tab').show();
            $('#outer-discussion').hide();
            $('#inline-discuss-upload').hide();

            $('.discussionBack').show();
            $('#discussion').find('.banner_first').show();
        }
    });
    $('.sidebar').removeClass('affix');
//    $('.sidebar').removeAttr("style");
...
$('.discussionBack').on('click', function() {
    ...
    $('#discussion').find('.banner_first').hide();
    $('#outer-discussion').show();
    $('#upload-discussion-tab').hide();
    $('#inline-discuss-upload').hide();
    $('.sidebar').removeClass('affix');
//    $('.sidebar').removeAttr("style");
//    $('.sidebar').removeClass('scroll-to-fixed-fixed');
...
$('.pollThread').on('click', function() {
    checkLoginOrNot(function(d) {
        if (d != "offline") {
            ...
            $('#outer-poll').hide();
            $('#poll-upload').show();
            $('#inline-poll-upload').hide();
            $('.pollBack').show();
            $('#poll').find('.banner_first').show();
        }
    });
    $('.sidebar').removeClass('affix');
//    $('.sidebar').removeAttr("style");
...
//            $('#uploadGamechat').show();
            ...
            $('#gameChat').addClass("active");
            $('#gamedialogue-upload').show();
            $('#outer-gameChat').hide();
            $('.gamechatBack').show();
            $('#gameChat').find('.banner_first').show();
...
$('.gamechatBack').on('click', function() {
    ...
    $('#index1,#news-outer,#gameChat,#event,#moment,#poll').removeClass("active");
    $('#gameChat').addClass("active");
    $('#gamedialogue-upload').hide();
    $('#outer-gameChat').show();
//    $('#uploadGamechat').hide();
    $('.sidebar').removeClass('affix');
    $('#gameChat').find('.banner_first').hide();
//    $('.sidebar').removeAttr("style");
//    $('.sidebar').removeClass('scroll-to-fixed-fixed');
});
