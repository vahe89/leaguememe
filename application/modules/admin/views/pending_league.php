            ...
            <div class="col-lg-12"> 
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">List All <?php echo $pendingdata;?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table style="width: 100%" class="table table-bordered table-hover" id="list_pending_records">
                            <thead>
                                <tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        var pending_record = "<?php echo $pendingdata?>";
        $('#list_pending_records').DataTable({
            "ordering": true,
            "bLengthChange": false,
            "info": true,
            "bProcessing": true,
            ...
            "bFilter": true,
            "sAjaxSource": base_url + "admin/leaguelist/pending_list_ajax",
            "aoColumnDefs": [
            ...
            {
                aoData.push({"name": "pending_type", "value": pending_record});
            },
        });
    });
</script>
