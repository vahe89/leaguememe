        ...
        <div class="col-sm-12 col-lg-12 ">
            ...
            <div class="post">
                ...
                <p class = "post-likes font-play">
                    ...
                    if (is_int($total_point) && $total_point >= 0) {
                        $points = "Victory";
                    } else {
                        $points = "Defeat";
                    }
                    ?>
                    <span id="point_<?php echo $anim_img->leagueimage_id; ?>"><?php echo $total_point; ?></span> <?php echo $points; ?> <span class="plus-sign"><i class="fa fa-plus"></i></span>
                    <span class="count">
                        <?php
                ...
                <ul class = "list-inline comments">
                    ...
                    ?>
                    <li><a href = "<?php echo base_url() . $anim_img->leagueimage_id; ?>#cmtclick"><i class = "fa fa-comment fa-lg"></i></a></li>
                    <?php
...
?>
<!--col-lg-10 col-xs-1 col-sm-5 col-sm-push-1 col-md-5 col-xs-6 col-xs-offset-0 pad-left-0 pad-right-0-->
<script>
