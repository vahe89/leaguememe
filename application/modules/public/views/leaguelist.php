...
class Leaguelist extends MX_Controller {
    ...
    function list_league() {
        ...
        $data['league_details'] = $this->leaguemod->list_league($main, $sub, $anime);
...
//
//
//        $all_images = $this->leaguemod->list_league(@$image_type, $category_id[0]['category_id']);
//
//        $next_image = 0;
//
//        reset($all_images);
...
//        $data['defact'] = $defact;
//
//        $data['youtube'] = $this->hm->get_all_youtube();
//        $data["side_links"] = $this->hm->get_all_sidelinks();
//
//        $data['left'] = "leaguememe.com";
