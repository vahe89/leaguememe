        ...
        <div class="wrapper-avatar pad-b-10 w-100">
            <div class="media info-avatar">
                ...
                <div class="media-body">
                    <h5><a href="<?php echo base_url(); ?>animemoment-profile/<?php echo $discussion->user_name ?>"><h5><?php echo empty($discussion->name) ? $discussion->user_name : $discussion->name; ?></h5></a>
                    </h5>
            ...
            <div class="list-pos">
                ...
                <span class="right-pos">
                    ...
                    ?>
                    <h5><a id="point_<?php echo $discussion->anime_discussionid; ?>"><?php echo $total_point; ?></a><a> points </a>&nbsp; -  &nbsp;
