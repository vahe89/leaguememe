...
<div classs="row">
    <div class="col-md-12 wrap-main">
        <input type="hidden" id="discussion_total_groups" value="<?php echo isset($allcount) ? $allcount : 0; ?>">
        <?php
        if (count($discussion_detail) > 0 && !empty($discussion_detail)) {
            foreach ($discussion_detail as $discussion) {
                ...
                ?>
                <div class="wrapper-avatar pad-b-10 w-100 popular-discussion" style="border: none;"> 
